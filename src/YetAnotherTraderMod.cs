...
public sealed class YetAnotherTraderModMod(
    ...
    TimeUtil timeUtil,
    TraderHelper traderHelper) : IOnLoad
{
    ...
    public Task OnLoad()
    {
        ...
        var traderImagePath = Path.Combine(pathToMod, "db/trader.png");
        ...
        traderHelper.AddTraderToLocales(traderBase, "Tony", "DevGru SOCOM JSOC Armory");
